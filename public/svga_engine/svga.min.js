! function(e, t) {
	...
	return function(e) {
		...
		o.isReserved = function(e) {
			...
			return !/^[$\w_]+$/.test(e) || o.isReserved(e) ? '["' + e.replace(a, "\\\\")
				.replace(f, '\\"') + '"]' : "." + e
		...
		(function(e) {
			...
			function n(e) {
				...
				return (t.prototype = Object.create(Error.prototype))
					.constructor = t, Object.defineProperty(t.prototype, "name", {
						get: function() {
							return e
						}
			...
			o.asPromise = r(17), o.base64 = r(38), o.EventEmitter = r(39), o.float = r(40), o.inquire = r(18), o.utf8 = r(41), o.pool = r(42), o.LongBits = r(43), o.isNode = Boolean(void 0 !== e && e && e.process && e.process.versions && e.process.versions.node), o.global = o.isNode && e || "undefined" != typeof window && window || "undefined" != typeof self && self || this, o.emptyArray = Object.freeze ? Object.freeze([]) : [], o.emptyObject = Object.freeze ? Object.freeze({}) : {}, o.isInteger = Number.isInteger || function(e) {
				...
				var r = e[t];
				return !(null == r || !e.hasOwnProperty(t)) && ("object" != typeof r || (Array.isArray(r) ? r.length : Object.keys(r)
					.length) > 0)
			}, o.Buffer = function() {
				try {
					var e = o.inquire("buffer")
						.Buffer;
				...
				return e ? o.LongBits.from(e)
					.toHash() : o.LongBits.zeroHash
		...
		function i(e, t, r, i, o, s, u) {
			...
			if (void 0 !== i && !l.test(i = i.toString()
				.toLowerCase())) throw TypeError("rule must be a string rule");
		...
		i.fromJSON = function(e, t) {
			...
			if (void 0 === (this.typeDefault = a.defaults[this.type]) && (this.resolvedType = (this.declaringField ? this.declaringField.parent : this.parent)
				.lookupTypeOrEnum(this.type), this.resolvedType instanceof o ? this.typeDefault = null : this.typeDefault = this.resolvedType.values[Object.keys(this.resolvedType.values)[0]]), this.options && null != this.options.default && (this.typeDefault = this.options.default, this.resolvedType instanceof s && "string" == typeof this.typeDefault && (this.typeDefault = this.resolvedType.values[this.typeDefault])), this.options && (!0 !== this.options.packed && (void 0 === this.options.packed || !this.resolvedType || this.resolvedType instanceof s) || delete this.options.packed, Object.keys(this.options)
				.length || (this.options = void 0)), this.long) this.typeDefault = f.Long.fromNumber(this.typeDefault, "u" === this.type.charAt(0)), Object.freeze && Object.freeze(this.typeDefault);
			...
			return "function" == typeof t ? t = f.decorateType(t)
				.name : t && "object" == typeof t && (t = f.decorateEnum(t)
					.name),
				function(o, s) {
					f.decorateType(o.constructor)
						.add(new i(s, e, t, r, {
							default: n
						}))
				}
		...
		Object.defineProperty(t, "__esModule", {
			...
			})(this, e), this._d = t, this._transform = r, this._styles = i
		}
	}, function(e, t, r) {
		"use strict";
		...
		n.fromJSON = function(e, t) {
			...
			return delete this.nested[e.name], Object.keys(this.nested)
				.length || (this.nested = void 0), e.onRemove(this), o(this)
			...
			if (i) {
				...
				for (var o = 0; o < this.nestedArray.length; ++o)
					if (this._nestedArray[o] instanceof n && (i = this._nestedArray[o].lookup(e, t, !0))) return i;
		...
		s.create = m(), s.alloc = function(e) {
			return new c.Array(e)
		}, c.Array !== Array && (s.alloc = c.pool(s.alloc, c.Array.prototype.subarray)), s.prototype._push = function(e, t, r) {
			return this.tail = this.tail.next = new i(e, t, r), this.len += t, this
		}, f.prototype = Object.create(i.prototype), f.prototype.fn = function(e, t, r) {
			for (; e > 127;) t[r++] = 127 & e | 128, e >>>= 7;
			t[r] = e
		}, s.prototype.uint32 = function(e) {
			return this.len += (this.tail = this.tail.next = new f((e >>>= 0) < 128 ? 1 : e < 16384 ? 2 : e < 2097152 ? 3 : e < 268435456 ? 4 : 5, e))
				.len, this
		...
		s.prototype.bytes = function(e) {
			...
			var t = y.length(e);
			return t ? this.uint32(t)
				._push(y.write, t, e) : this._push(a, 1, 0)
			...
			var e = this.head,
				...
				r = this.len;
			return this.reset()
				.uint32(r), r && (this.tail.next = e.next, this.tail = t, this.len += r), this
		...
		i.fromJSON = function(e, t) {
			...
			for (var t, r = 0; r < this.fieldsArray.length; ++r)(t = this.fieldsArray[r])
				.parent && t.parent.remove(t);
			o.prototype.onRemove.call(this, e)
		}, i.d = function() {
			for (var e = new Array(arguments.length), t = 0; t < arguments.length;) e[t] = arguments[t++];
			return function(t, r) {
				a.decorateType(t.constructor)
					.add(new i(r, e)), Object.defineProperty(t, r, {
						get: a.oneOfGetter(e),
						set: a.oneOfSetter(e)
					})
			}
		...
		t.RectPath = function(e) {
			function t(e, r, i, n, o, s, a) {
				...
				var f = function(e, t) {
					...
					.call(this));
				return f._x = e, f._y = r, f._width = i, f._height = n, f._cornerRadius = o, f._transform = s, f._styles = a, f
			}
			return function(e, t) {
		...
		e.exports = function(e) {
			for (var t, r = s.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), a = e.fieldsArray.slice()
				.sort(s.compareFieldsById), f = 0; f < a.length; ++f) {
				var l = a[f].resolve(),
		...
		Object.defineProperties(i.prototype, {
			...
			ctor: {
				...
				set: function(e) {
					var t = e.prototype;
					t instanceof h || ((e.prototype = new h)
						.constructor = e, p.merge(e.prototype, t)), e.$type = e.prototype.$type = this, p.merge(e, h, !0), this._ctor = e;
					for (var r = 0; r < this.fieldsArray.length; ++r) this._fieldsArray[r].resolve();
					var i = {};
					for (r = 0; r < this.oneofsArray.length; ++r) i[this._oneofsArray[r].resolve()
						.name] = {
			...
			for (var t, r = p.codegen(["p"], e.name), i = 0; i < e.fieldsArray.length; ++i)(t = e._fieldsArray[i])
				.map ? r("this%s={}", p.safeProp(t.name)) : t.repeated && r("this%s=[]", p.safeProp(t.name));
			...
			for (var e = this.fullName, t = [], r = 0; r < this.fieldsArray.length; ++r) t.push(this._fieldsArray[r].resolve()
				.resolvedType);
			this.encode = y(this)({
				Writer: d,
				types: t,
			...
			return this.encode(e, t && t.len ? t.fork() : t)
				.ldelim()
		...
		i.fromJSON = function(e, t) {
			...
			return "function" == typeof r ? r = s.decorateType(r)
				.name : r && "object" == typeof r && (r = s.decorateEnum(r)
					.name),
				function(n, o) {
					s.decorateType(n.constructor)
						.add(new i(o, e, t, r))
				}
		}
	}, function(e, t, r) {
		...
		i.fromJSON = function(e, t) {
			...
			for (var i, n = new f.Service(e, t, r), o = 0; o < this.methodsArray.length; ++o) {
				var s = a.lcFirst((i = this._methodsArray[o])
						.resolve()
						.name)
					.replace(/[^$\w_]/g, "");
		...
		o.fromObject = function(e) {
			...
			var t = e.fieldsArray.slice()
				.sort(a.compareFieldsById);
			if (!t.length) return a.codegen()("return {}");
			for (var r = a.codegen(["m", "o"], e.name + "$toObject")("if(!o)")("o={}")("var d={}"), i = [], o = [], f = [], l = 0; l < t.length; ++l) t[l].partOf || (t[l].resolve()
					.repeated ? i : t[l].map ? o : f)
				.push(t[l]);
			if (i.length) {
			...
			if (f.length) {
				for (r("if(o.defaults){"), l = 0; l < f.length; ++l) {
					...
					if (u.resolvedType instanceof s) r("d%s=o.enums===String?%j:%j", h, u.resolvedType.valuesById[u.typeDefault], u.typeDefault);
						...
						var c = "[" + Array.prototype.slice.call(u.typeDefault)
							.join(",") + "]";
		...
		i.fromJSON = function(e, t) {
		...
		}, i.prototype.resolvePath = d.path.resolve, i.prototype.fetch = d.fetch, i.prototype.load = function e(t, r, i) {
			function o(e, t) {
				if (i) {
					var r = i;
					if (i = null, c) throw e;
			...
			function u(e, t) {
				if (!(h.files.indexOf(e) > -1)) {
					if (h.files.push(e), e in l) return void(c ? a(e, l[e]) : (++p, setTimeout((function() {
						--p, a(e, l[e])
					}))));
					if (c) {
						var r;
						try {
							r = d.fs.readFileSync(e)
								.toString("utf8")
						} catch (e) {
							return void(t || o(e))
						}
						a(e, r)
					} else ++p, h.fetch(e, (function(r, n) {
						if (--p, i) return r ? void(t ? p || o(null, h) : o(r)) : void a(e, n)
					}))
				}
			}
		...
		r(5), r(14), r(15), t.SpriteEntity = function e(t) {
			(function(e, t) {
				if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
			})(this, e), this.matteKey = null, this.imageKey = null, this.frames = [], this.matteKey = t.matteKey, this.imageKey = t.imageKey, t.frames && (this.frames = t.frames.map((function(e) {
		...
		t.FrameEntity = function e(t) {
			(function(e, t) {
				if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
			})(this, e), this.alpha = 0, this.transform = {
				a: 1,
				b: 0,
				c: 0,
				d: 1,
				...
				width: 0,
				height: 0
			}, this.nx = 0, this.ny = 0, this.maskPath = null, this.shapes = [], this.alpha = parseFloat(t.alpha) || 0, t.layout && (this.layout.x = parseFloat(t.layout.x) || 0, this.layout.y = parseFloat(t.layout.y) || 0, this.layout.width = parseFloat(t.layout.width) || 0, this.layout.height = parseFloat(t.layout.height) || 0), t.transform && (this.transform.a = parseFloat(t.transform.a) || 1, this.transform.b = parseFloat(t.transform.b) || 0, this.transform.c = parseFloat(t.transform.c) || 0, this.transform.d = parseFloat(t.transform.d) || 1, this.transform.tx = parseFloat(t.transform.tx) || 0, this.transform.ty = parseFloat(t.transform.ty) || 0), t.clipPath && t.clipPath.length > 0 && (this.maskPath = new i.BezierPath(t.clipPath, void 0, {
				fill: "#000000"
		...
		i.encode = function(e, t, r) {
			for (var i, o = null, s = [], a = 0, f = 0; t < r;) {
				...
				a > 8191 && ((o || (o = []))
					.push(String.fromCharCode.apply(String, s)), a = 0)
			}
		...
		i.length = function(e) {
			...
			if (r - t < 1) return "";
			for (var i, n = null, o = [], s = 0; t < r;)(i = e[t++]) < 128 ? o[s++] = i : i > 191 && i < 224 ? o[s++] = (31 & i) << 6 | 63 & e[t++] : i > 239 && i < 365 ? (i = ((7 & i) << 18 | (63 & e[t++]) << 12 | (63 & e[t++]) << 6 | 63 & e[t++]) - 65536, o[s++] = 55296 + (i >> 10), o[s++] = 56320 + (1023 & i)) : o[s++] = (15 & i) << 12 | (63 & e[t++]) << 6 | 63 & e[t++], s > 8191 && ((n || (n = []))
				.push(String.fromCharCode.apply(String, o)), s = 0);
		...
		i._configure = function() {
			i.alloc = s._Buffer_allocUnsafe, i.writeBytesBuffer = s.Buffer && s.Buffer.prototype instanceof Uint8Array && "set" === s.Buffer.prototype.set.name ? function(e, t, r) {
				t.set(e, r)
			} : function(e, t, r) {
		...
		e.exports = i;
		var n = r(1);
		(i.prototype = Object.create(n.EventEmitter.prototype))
		.constructor = i, i.prototype.rpcCall = function e(t, r, i, o, s) {
			if (!o) throw TypeError("request must be specified");
			var a = this;
			if (!s) return n.asPromise(e, a, t, r, i, o);
			if (a.rpcImpl) try {
				return a.rpcImpl(t, r[a.requestDelimited ? "encodeDelimited" : "encode"](o)
					.finish(), (function(e, r) {
			...
			return this.rpcImpl && (e || this.rpcImpl(null, null, null), this.rpcImpl = null, this.emit("end")
				.off()), this
		}
	}, function(e, t, r) {
		"use strict";
			...
			function r(e) {
				if ("string" != typeof e) {
					...
					if (i.verbose && console.log("codegen: " + t), t = "return " + t, e) {
						...
						return a[l] = t, Function.apply(null, a)
							.apply(null, f)
					}
					return Function(t)()
				}
		...
		function i(e, t, r) {
			return "function" == typeof t ? (r = t, t = {}) : t || (t = {}), r ? !t.xhr && o && o.readFile ? o.readFile(e, (function(n, o) {
		...
		i.resolve = function(e, t, r) {
			return r || (t = o(t)), n(t) ? t : (r || (e = o(e)), (e = e.replace(/(?:\/|^)[^/]+$/, ""))
				.length ? o(e + "/" + t) : t)
		}
	}, function(e, t, r) {
		"use strict";
			...
			l = {
				loadAssets: function(e, t, r) {
					if ("object" === ("undefined" == typeof JSZipUtils ? "undefined" : i(JSZipUtils)) && "function" == typeof JSZip)
						if ("[object File]" == e.toString()) l._readBlobAsArrayBuffer(e, (function(e) {
							...
							80 == i[0] && 75 == i[1] && 3 == i[2] && 4 == i[3] ? JSZip.loadAsync(e)
								.then((function(e) {
									l._decodeAssets(e, t)
						...
						80 == n[0] && 75 == n[1] && 3 == n[2] && 4 == n[3] ? JSZip.loadAsync(i)
							.then((function(e) {
								l._decodeAssets(e, t)
				...
				load_viaProto: function(e, t, r) {
					try {
						...
						if (r) return void r(e);
						throw console.error(e), e
					}
				},
				_decodeAssets: function(e, t) {
					var r = "1.0";
					e.file("movie.binary") && (r = "1.5"), e.file("movie.spec")
						.async("string")
						.then((function(i) {
							var n = JSON.parse(i),
								o = {};
							n.ver = r, l._loadImages(o, e, n, (function() {
								t({
									movie: n,
									images: o
								})
						...
						if (t) e: for (var u in r.images) {
							switch (function(i) {
								if (r.images.hasOwnProperty(i)) {
									var n = r.images[i],
										u = f(n);
									return e.hasOwnProperty(i) ? "continue" : (a = !1, t.file(u + ".png")
										.async("base64")
										.then(function(n) {
											e[i] = n, l._loadImages(e, t, r, o)
										}.bind(s)), "break")
								}
							}(u)) {
								case "continue":
		...
		}, t.Inflate = i, t.inflate = n, t.inflateRaw = function(e, t) {
			return (t = t || {})
				.raw = !0, n(e, t)
		}, t.ungzip = n
	}, function(e, t, r) {
		...
		function o(e) {
			var t;
			return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = C, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new d.Buf32(ue), t.distcode = t.distdyn = new d.Buf32(he), t.sane = 1, t.back = -1, O) : j
		}

		function s(e) {
			var t;
			return e && e.state ? ((t = e.state)
				.wsize = 0, t.whave = 0, t.wnext = 0, o(e)) : j
		}

		function a(e, t) {
			var r, i;
			return e && e.state ? (i = e.state, t < 0 ? (r = 0, t = -t) : (r = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? j : (null !== i.window && i.wbits !== t && (i.window = null), i.wrap = r, i.wbits = t, s(e))) : j
		}

		function f(e, t) {
			var r, i;
			return e ? (i = new n, e.state = i, i.window = null, (r = a(e, t)) !== O && (e.state = null), r) : j
		}
		...
		function u(e, t, r, i) {
			var n, o = e.state;
			return null === o.window && (o.wsize = 1 << o.wbits, o.wnext = 0, o.whave = 0, o.window = new d.Buf8(o.wsize)), i >= o.wsize ? (d.arraySet(o.window, t, r - o.wsize, o.wsize, 0), o.wnext = 0, o.whave = o.wsize) : ((n = o.wsize - o.wnext) > i && (n = i), d.arraySet(o.window, t, r - i, n, o.wnext), (i -= n) ? (d.arraySet(o.window, t, r - i, i, 0), o.wnext = i, o.whave = o.wsize) : (o.wnext += n, o.wnext === o.wsize && (o.wnext = 0), o.whave < o.wsize && (o.whave += n))), 0
		}
		var h, c, d = r(8),
			p = r(53),
			y = r(54),
			...
			ce = 15,
			de = !0;
		t.inflateReset = s, t.inflateReset2 = a, t.inflateResetKeep = o, t.inflateInit = function(e) {
			return f(e, ce)
			...
			(r = e.state)
			.mode === Z && (r.mode = K), a = e.next_out, o = e.output, h = e.avail_out, s = e.next_in, n = e.input, f = e.avail_in, c = r.hold, ue = r.bits, he = f, ce = h, xe = O;
			e: for (;;) switch (r.mode) {
				case C:
					if (0 === r.wrap) {
						r.mode = K;
					...
					if (2 & r.wrap && 35615 === c) {
						r.check = 0, je[0] = 255 & c, je[1] = c >>> 8 & 255, r.check = y(r.check, je, 2, 0), c = 0, ue = 0, r.mode = B;
						break
					}
					if (r.flags = 0, r.head && (r.head.done = !1), !(1 & r.wrap) || (((255 & c) << 8) + (c >> 8)) % 31) {
						e.msg = "incorrect header check", r.mode = ae;
						break
					}
					if ((15 & c) !== F) {
						e.msg = "unknown compression method", r.mode = ae;
						break
					}
					if (ue -= 4, ke = 8 + (15 & (c >>>= 4)), 0 === r.wbits) r.wbits = ke;
					else if (ke > r.wbits) {
						e.msg = "invalid window size", r.mode = ae;
						break
					}
				...
				case B:
					...
					if (r.flags = c, (255 & r.flags) !== F) {
						e.msg = "unknown compression method", r.mode = ae;
						break
					}
					if (57344 & r.flags) {
						e.msg = "unknown header flags set", r.mode = ae;
						break
					}
				...
				case M:
					if (2048 & r.flags) {
						...
						de = 0;
						do {
							ke = n[s + de++], r.head && ke && r.length < 65536 && (r.head.name += String.fromCharCode(ke))
						} while (ke && de < f);
				...
				case L:
					if (4096 & r.flags) {
						...
						de = 0;
						do {
							ke = n[s + de++], r.head && ke && r.length < 65536 && (r.head.comment += String.fromCharCode(ke))
						} while (ke && de < f);
						if (512 & r.flags && (r.check = y(r.check, n, de, s)), f -= de, s += de, ke) break e
				...
				case z:
					if (512 & r.flags) {
						...
						if (c !== (65535 & r.check)) {
							e.msg = "header crc mismatch", r.mode = ae;
							break
						}
						c = 0, ue = 0
					}
				...
				case q:
					...
					if ((65535 & c) != (c >>> 16 ^ 65535)) {
						e.msg = "invalid stored block lengths", r.mode = ae;
						break
					}
				...
				case H:
					...
					if (r.nlen = 257 + (31 & c), c >>>= 5, ue -= 5, r.ndist = 1 + (31 & c), c >>>= 5, ue -= 5, r.ncode = 4 + (15 & c), c >>>= 4, ue -= 4, r.nlen > 286 || r.ndist > 30) {
						e.msg = "too many length or distance symbols", r.mode = ae;
						break
					}
					r.have = 0, r.mode = W;
				case W:
					...
					if (r.lencode = r.lendyn, r.lenbits = 7, Oe = {
						bits: r.lenbits
					}, xe = v(g, r.lens, 0, 19, r.lencode, 0, r.work, Oe), r.lenbits = Oe.bits, xe) {
						e.msg = "invalid code lengths set", r.mode = ae;
						break
					}
					r.have = 0, r.mode = G;
				case G:
					for (; r.have < r.nlen + r.ndist;) {
						...
						if (ge < 16) c >>>= me, ue -= me, r.lens[r.have++] = ge;
							...
							if (16 === ge) {
								...
								if (c >>>= me, ue -= me, 0 === r.have) {
									e.msg = "invalid bit length repeat", r.mode = ae;
									break
								}
					...
					if (r.mode === ae) break;
					if (0 === r.lens[256]) {
						e.msg = "invalid code -- missing end-of-block", r.mode = ae;
						break
					}
					if (r.lenbits = 9, Oe = {
						bits: r.lenbits
					}, xe = v(b, r.lens, 0, r.nlen, r.lencode, 0, r.work, Oe), r.lenbits = Oe.bits, xe) {
						e.msg = "invalid literal/lengths set", r.mode = ae;
						break
					}
					if (r.distbits = 6, r.distcode = r.distdyn, Oe = {
						bits: r.distbits
					}, xe = v(_, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, Oe), r.distbits = Oe.bits, xe) {
						e.msg = "invalid distances set", r.mode = ae;
						break
					}
				...
				case Q:
					if (f >= 6 && h >= 258) {
						e.next_out = a, e.avail_out = h, e.next_in = s, e.avail_in = f, r.hold = c, r.bits = ue, m(e, ce), a = e.next_out, o = e.output, h = e.avail_out, s = e.next_in, n = e.input, f = e.avail_in, c = r.hold, ue = r.bits, r.mode === Z && (r.back = -1);
						break
					}
					...
					if (c >>>= me, ue -= me, r.back += me, r.length = ge, 0 === ve) {
						r.mode = ie;
						break
					}
					if (32 & ve) {
					...
					if (64 & ve) {
						e.msg = "invalid literal/length code", r.mode = ae;
						break
					}
				...
				case ee:
					...
					if (c >>>= me, ue -= me, r.back += me, 64 & ve) {
						e.msg = "invalid distance code", r.mode = ae;
						break
					}
				...
				case te:
					...
					if (r.offset > r.dmax) {
						e.msg = "invalid distance too far back", r.mode = ae;
						break
					}
					r.mode = re;
				case re:
					if (0 === h) break e;
					if (de = ce - h, r.offset > de) {
						if ((de = r.offset - de) > r.whave && r.sane) {
							e.msg = "invalid distance too far back", r.mode = ae;
							break
						}
						de > r.wnext ? (de -= r.wnext, pe = r.wsize - de) : pe = r.wnext - de, de > r.length && (de = r.length), ye = r.window
				...
				case ne:
					if (r.wrap) {
						...
						if (ce -= h, e.total_out += ce, r.total += ce, ce && (e.adler = r.check = r.flags ? y(r.check, o, ce, a - ce) : p(r.check, o, ce, a - ce)), ce = h, (r.flags ? c : i(c)) !== r.check) {
							e.msg = "incorrect data check", r.mode = ae;
							break
						}
						c = 0, ue = 0
					}
				...
				case oe:
					if (r.wrap && r.flags) {
						...
						if (c !== (4294967295 & r.total)) {
							e.msg = "incorrect length check", r.mode = ae;
							break
						}
						c = 0, ue = 0
					}
			...
			return e && e.state ? 0 == (2 & (r = e.state)
				.wrap) ? j : (r.head = t, t.done = !1, O) : j
		}, t.inflateSetDictionary = function(e, t) {
			var r, i = t.length;
			return e && e.state ? 0 !== (r = e.state)
				.wrap && r.mode !== U ? j : r.mode === U && p(1, t, i, 0) !== r.check ? T : u(e, t, i, i) ? (r.mode = fe, E) : (r.havedict = 1, O) : j
		...
		function i(e, t) {
			if (t < 65534 && (e.subarray && s || !e.subarray && o)) return String.fromCharCode.apply(null, n.shrinkBuf(e, t));
		...
		"undefined" != typeof self && self, e.exports = function(e) {
			...
			var i = function() {
				...
				return e.prototype.start = function(e) {
					...
					return "undefined" == typeof performance ? (new Date)
		...
		t.Renderer = function() {
			function e(t) {
				(function(e, t) {
					if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
				})(this, e), this._owner = void 0, this._prepared = !1, this._undrawFrame = void 0, this._bitmapCache = void 0, this._soundsQueue = [], this._owner = t
			}
			return n(e, [{
				key: "dataURLtoBlob",
				value: function(e) {
				...
				value: function() {
					var e, t, r = this;
					if (this._prepared = !1, this._bitmapCache = void 0, void 0 === this._owner._videoItem.images || 0 == Object.keys(this._owner._videoItem.images)
						.length) return this._bitmapCache = {}, void(this._prepared = !0);
					void 0 === this._bitmapCache && function() {
						...
						for (e in r._owner._videoItem.images) {
							...
							if (0 === o.indexOf("iVBO") || 0 === o.indexOf("/9j/2w")) {
								...
								}.bind(r), s.src = "data:image/png;base64," + o;
								var a = e.replace(".matte", "");
								r._bitmapCache[a] = s
							} else 0 === o.indexOf("SUQz") && void 0 !== window.Howl && (i++, (t = new Howl({
								...
								.once("load", function() {
									++n == i && (this._prepared = !0, "number" == typeof this._undrawFrame && (this.drawFrame(this._undrawFrame), this._undrawFrame = void 0))
								}.bind(r)), t.on("loaderror", (function(e) {
									console.error(e)
								})), r._bitmapCache[e] = t)
						}
					}()
				...
				key: "clear",
				value: function() {
					var e = (this._owner._drawingCanvas || this._owner._container)
						.getContext("2d"),
						t = {
							x: 0,
							y: 0,
				...
				value: function(e) {
					var t = this;
					if (this._prepared) {
						var r = (this._owner._drawingCanvas || this._owner._container)
							.getContext("2d"),
							i = {
								x: 0,
								y: 0,
				...
				value: function(e, t) {
					...
					e.beginPath(), t._d.replace(/([a-zA-Z])/g, "|||$1 ")
						.replace(/,/g, " ")
						.split("|||")
						.forEach((function(t) {
							if (0 != t.length) {
